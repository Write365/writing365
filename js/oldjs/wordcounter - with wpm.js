...
jQuery(document).ready(function() {
	...
	//tie functions to the body
	jQuery('#edit-body-und-0-value').wpmcount({counterElement:"wpmcount"});
...
jQuery.fn.wpmcount = function(params){
	...
	{ 
		...
		if (iLastTime != 0) {
			...
			jQuery('[name="hiddenwordsperminutefield"]').val(wpm);			
			jQuery('#wpm').html(wpm);
...
/********************************************************************************* 
OLD JQUERY function that uses javascript to count the words. NOT PHPJS function. 
********************************************************************************* 
...
jQuery.fn.wordCount = function(params){
	...
	{ 
		total_words=this.value.split(/[\s\.\?]+/).length;
		jQuery('[name="hiddenwordcountfield"]').val(total_words);
...
jQuery.fn.wordCount = function(params){
	...
	{ 
		...
		var count = str_word_count(this.value);			//Calling str_word_count function here. 
